...
macro(KlayGEUseSharedPch target_name pch_header pch_output pch_pdb)
	...
	elseif(KLAYGE_PLATFORM_DARWIN OR KLAYGE_PLATFORM_IOS)
		set_target_properties(${target_name} PROPERTIES XCODE_ATTRIBUTE_GCC_PRECOMPILE_PREFIX_HEADER YES)
		set_target_properties(${target_name} PROPERTIES XCODE_ATTRIBUTE_GCC_PREFIX_HEADER "${pch_output}")
	else()
		set_target_properties(${target_name} PROPERTIES COMPILE_FLAGS "-include ${pch_output} -Winvalid-pch")
	endif()
endmacro()
